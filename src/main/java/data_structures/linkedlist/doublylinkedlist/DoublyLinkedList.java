...
import data_structures.linkedlist.doublylinkedlist.Node;
import enums.ErrorCodeEnum;
import error_handler.ErrorBaseInfo;

/**
 * @author LiadiJason
 * @version $Id: DoublyLinkedList.java, 2023-08-10:57 AM LiadiJason
 */
public class DoublyLinkedList extends ErrorBaseInfo {
    private Node head;
    private Node tail;
    private int length;
    ...
    public void remove(int index) {
        if (index < 0 && index < length) {
            ...
            data_structures.linkedlist.singlylinkedlist.Node currentNode = head;
            for (int i = 0; i < length - 1; i++) {
                currentNode = currentNode.next;
            }
